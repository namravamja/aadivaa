...
-- AddForeignKey
ALTER TABLE "Order" ADD CONSTRAINT "Order_shippingAddressId_fkey" FOREIGN KEY ("shippingAddressId") REFERENCES "buyer_addresses"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
