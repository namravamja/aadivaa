        ...
        <div class="email-wrapper">
          <div class="container">
            ...
            <div class="content">
              ...
              <div class="message">
                We received a request to reset the password for your Aadivaa Earth ${
                  userType === "artist" ? "artist" : "buyer"
                } account. Don't worry, we've got you covered!
              </div>
...
export const sendArtistForgotPasswordEmail = async (
  email: string,
  resetToken: string
) => {
  return sendForgotPasswordEmail(email, resetToken, "artist");
};
