...
export const sendOrderConfirmationEmail = async (
  ...
  const orderItemsHTML = items
    .map(
      (item) => `
      <tr>
        <td style="padding:15px 0;border-bottom:1px solid #eee;font-size:16px;color:#333;">${
          item.name
        }</td>
        <td style="padding:15px 0;border-bottom:1px solid #eee;text-align:center;font-size:16px;color:#666;">${
          item.quantity
        }</td>
        <td style="padding:15px 0;border-bottom:1px solid #eee;text-align:right;font-size:16px;font-weight:600;color:#333;">₹${item.price.toFixed(
          2
        )}</td>
      </tr>
    `
  ...
  const message = {
    from: '"Aadivaa Earth" <no-reply@aadivaa.com>',
    to: email,
    subject: `✅ Order Confirmed #${shortOrderId} - Aadivaa Earth`,
    html: `
      <!DOCTYPE html>
      <html>
      <head>
          ...
          <tr>
            <td align="center">
              <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;margin:0 auto;">
                ...
                <!-- Header -->
                <tr>
                  <td style="padding:40px 50px 30px;text-align:center;background-color:#2563eb;">
                    <h1 style="margin:0;color:#ffffff;font-size:28px;font-weight:bold;letter-spacing:-0.5px;">Aadivaa Earth</h1>
                    <p style="margin:8px 0 0;color:#dbeafe;font-size:14px;">Sustainable Shopping Made Simple</p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding:40px 50px 20px;text-align:center;">
                    <div style="width:60px;height:60px;background-color:#10b981;border-radius:50%;margin:0 auto 20px;position:relative;">
                        ...
                        <td style="padding:20px;">
                          <table width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                              ...
                              <td style="padding-top:8px;text-align:right;font-size:14px;color:#6b7280;">${new Date(
                                placedAt
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" style="margin-top:20px;">
                      <tr>
                        <td style="padding:15px 0;border-top:2px solid #e5e7eb;text-align:right;">
                          <span style="font-size:18px;font-weight:700;color:#1f2937;">Total: ₹${totalAmount.toFixed(
                            2
                          )}</span>
                        </td>
                      </tr>
                ...
                <tr>
                  <td style="padding:0 50px 30px;">
                    ...
                    <div style="background-color:#f9fafb;padding:20px;border-radius:8px;line-height:1.6;">
                      <p style="margin:0 0 5px;font-weight:600;color:#1f2937;">${
                      ...
                      <p style="margin:0;color:#6b7280;font-size:14px;">Phone: ${
                ...
                <tr>
                  <td style="padding:0 50px 40px;text-align:center;">
                    <a href="https://www.aadivaa.shop/Buyer/TrackOrder/${orderId}" 
                ...
                <!-- Support -->
                <tr>
                  <td style="padding:0 50px 40px;text-align:center;border-top:1px solid #e5e7eb;">
                    <p style="margin:20px 0 5px;font-size:16px;color:#374151;font-weight:600;">Need Help?</p>
                    <p style="margin:0;font-size:14px;color:#6b7280;">
                      Contact us at <a href="mailto:support@aadivaa.com" style="color:#2563eb;text-decoration:none;">support@aadivaa.com</a>
                    </p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding:20px 50px;background-color:#f9fafb;text-align:center;">
                    <p style="margin:0;font-size:12px;color:#9ca3af;">
                      &copy; ${new Date().getFullYear()} Aadivaa Earth. All rights reserved.
                    </p>
                  </td>
                </tr>
