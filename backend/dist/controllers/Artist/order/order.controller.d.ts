...
export declare const getArtistOrders: (req: AuthenticatedRequest, res: Response) => Promise<void>;
...
export declare const getOrderItemsByArtist: (req: AuthenticatedRequest, res: Response) => Promise<void>;
