  ...
  return (
    <main className="pt-24 pb-16">
      <div className="container mx-auto px-4">
        ...
        {/* Show "No orders found" when filters are active but no results OR when no orders at all but filters are active */}
        ...
        ((!orders || orders.length === 0) && hasActiveFilters) ? (
          <div className="text-center py-16">
            ...
            <button
              ...
              className="bg-terracotta-600 hover:bg-terracotta-700 text-white px-4 py-2 text-sm font-medium transition-colors cursor-pointer rounded"
            >
              Clear Filters
            </button>
          </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center pt-4 border-t border-stone-200">
                    ...
                    <div className="flex space-x-2">
                      <Link href={`/Buyer/TrackOrder/${order.id}`}>
